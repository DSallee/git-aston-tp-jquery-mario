$(function(){
    ...
    $(document).keydown(function(e) {
        ...
        if (code == right) {
            ...
            .animate({right: "+=" + distance}, time, 'linear');
        ...
        if (code == left) {
            ...
            .stop()
            .css({transform: "translate(" + x + "px," + y + "px)"})
            .animate({left: "=+" + distance},{duration: 0}, time, 'linear');
        ...
        if (code == jump) {
            console.log(x);
            var jumpPosStart = {'transform' : "translate(" + x + "px," + y + "%), bottom: 0"};
            var jumpPosY1 = {'transform' : "translate(" + x + "px, 20%), bottom: 80px"};
            var jumpPosY2 = {'transform' : "translate(" + x + "px, 50%), bottom: 100px"};
            var jumpPosY3 = {'transform' : "translate(" + x + "px, 80%), bottom: 80px"};
            var jumpPosEnd = {'transform' : "translate(" + x + "px, 100%), bottom: 0"};
